const BannerNormativas = () => {
    return (
        <div>
            <section
                className="relative bg-[url(/fotos-carousel/piscina_2.jpg)] bg-cover bg-center transition-transform sm:bg-scale-110"
...
export default BannerNormativas;
