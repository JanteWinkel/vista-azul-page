const BannerFinanzas = () => {
    return (
        <div>
            <section
                className="relative bg-[url(/fotos-carousel/calle_1.jpg)] bg-cover bg-center transition-transform sm:bg-scale-110"
