...
; // Deuda General
const deudaPrimeraEtapa = 32379.90; // Deuda de la Primera Etapa
const deudaSegundaEtapa = 12600.19; // Deuda de la Segunda Etapa

const Deudas = () => {
    return (
        <div className="mt-12">
            <h2 className="text-2xl font-semibold text-primary mb-1">DEUDA GENERAL</h2>
            <h4 className="font-semibold  mb-4">Fecha (22/05/2025)</h4>
