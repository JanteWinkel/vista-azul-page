...
; // Deuda General
const deudaPrimeraEtapa = 38010.39; // Deuda de la Primera Etapa
const deudaSegundaEtapa = 14739.63; // Deuda de la Segunda Etapa

const Deudas = () => {
    return (
        <div className="mt-12">
            <h2 className="text-2xl font-semibold text-primary mb-1">DEUDA GENERAL</h2>
            <h4 className="font-semibold  mb-4">Fecha (12/08/2025)</h4>
