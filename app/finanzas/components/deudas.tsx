...
; // Deuda General
const deudaPrimeraEtapa = 43110.33; // Deuda de la Primera Etapa
const deudaSegundaEtapa = 17673.59; // Deuda de la Segunda Etapa

const Deudas = () => {
    return (
        <div className="mt-12">
            <h2 className="text-2xl font-semibold text-primary mb-1">DEUDA GENERAL</h2>
            <h4 className="font-semibold  mb-4">Fecha (05/02/2026)</h4>
