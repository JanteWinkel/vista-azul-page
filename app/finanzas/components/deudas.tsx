...
; // Deuda General
const deudaPrimeraEtapa = 33788.88; // Deuda de la Primera Etapa
const deudaSegundaEtapa = 12984.13; // Deuda de la Segunda Etapa

const Deudas = () => {
    return (
        <div className="mt-12">
            <h2 className="text-2xl font-semibold text-primary mb-1">DEUDA GENERAL</h2>
            <h4 className="font-semibold  mb-4">Fecha (30/12/2025)</h4>
