...
const recurringEvents: Event[] = [
    {
        title: "Bombeo de agua a las casas",
...
const holidayEvents: Holiday[] = [
    {
        date: new Date(2025, 0, 1), // Año Nuevo
        title: "Año Nuevo",
        emoji: "🎉",
    },
    {
        date: new Date(2025, 2, 19), // Día de San José
...
const EventCalendar = () => {
    ...
    return (
        <div className="mt-16">
            <div className="event-calendar flex flex-col md:flex-row p-4 md:py-8 max-w-6xl px-4 py-8 mx-auto sm:px-6 ">
                <div className="flex-1 mt-8">
                    <h5 className="text-3xl text-primary font-extrabold uppercase text-center mt-10 mb-8">
