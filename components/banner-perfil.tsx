...
const BannerPerfil = () => {
    return (
        <>
            <div className="flex max-w-6xl px-4 pt-4 mx-auto sm:px-6 lg:px-8 justify-center text-center">
                <div></div>
                <div>
                    ...
                    <p className="my-2">Tu espacio para mantenerte informado y conectado con la comunidad.</p>
                </div>
            </div>
        </>
    );
